...
try:
    ...
    # Adicionado iface="Software Loopback Interface 1" porque no Windows o loopback não é escutado por defeito
    sniff(iface="Software Loopback Interface 1", prn=capturar_pacote, store=0)
